...
tbl <- reactable(sd_tbl,
                 ...
                 columns = list(
                   ...
                   top_recommendation = colDef(name = "Top recommendaton", sortable = FALSE, filterable = FALSE),
                   also_recommended = colDef(name = "Also recommended", sortable = FALSE, filterable = FALSE),
